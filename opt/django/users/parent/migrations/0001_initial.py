    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='auth_token', to=settings.AUTH_USER_MODEL, verbose_name='Parent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='student_mm_parent', to='student.User', verbose_name='student_mm_parent')),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='student',
            field=models.ManyToManyField(blank=True, null=True, related_name='student', through='parent.ParentStudentMM', to='student.User', verbose_name='parent_student'),
        ),
        migrations.AddField(
            model_name='user',
