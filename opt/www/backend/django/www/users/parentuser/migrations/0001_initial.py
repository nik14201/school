...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('student', '0002_auto_20200505_1430'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='auth_token', to=settings.AUTH_USER_MODEL, verbose_name='ParentUser')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='student',
            field=models.ManyToManyField(blank=True, null=True, related_name='student', through='parentuser.ParentStudentMM', to='student.Student', verbose_name='parent_student'),
        ),
        migrations.AddField(
            model_name='parentuser',
