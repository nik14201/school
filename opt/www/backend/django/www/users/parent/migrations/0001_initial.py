    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='student', to='student.Student', verbose_name='parent_student')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='parent_set', related_query_name='parent', to='auth.Permission', verbose_name='parent permissions')),
            ],
            options={
