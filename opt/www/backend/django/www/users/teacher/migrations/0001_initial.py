    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='auth_token_teacher', to=settings.AUTH_USER_MODEL, verbose_name='Teacher')),
            ],
            options={
                'abstract': False,
            },
